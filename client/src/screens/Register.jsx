            ...
            <div class="bg-white px-10 py-8 rounded-xl w-screen shadow-md max-w-sm">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <input type="password"
                  placeholder="**********" class="bg-indigo-50 px-4 py-2 outline-none rounded-md w-full" />
                </div>
              </div>
              <button class="mt-4 w-full bg-gradient-to-tr from-emerald-800  text-indigo-100 py-2 rounded-md text-lg tracking-wide">Register</button>
            </div>
          </form>
        </div>
    );

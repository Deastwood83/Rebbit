...
>>>>>>> a260a7130766f94d26ed2e7af266440253b3f2a6
...
=======
  return (
    <div className="h-screen bg-gradient-to-br from-emerald-800 to-green-700">
      <section class="py-26">
...
>>>>>>> a260a7130766f94d26ed2e7af266440253b3f2a6
              ...
              <p class="text-center font-extrabold">
                Don&rsquo;t have an account?{" "}
                <Link to={"/register"} class="text-yellow-400 hover:underline">
                  Sign up
                </Link>
              </p>
            </form>
